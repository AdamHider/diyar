...
<div class="exercise-manager-edit">
    <div class="action-block">
        ...
        <button class="button button-mini save"><i class="fa fa-check"></i>Save</button>
    </div>
                        ...
                        <?php if(!empty($question->answers)){ 
                            foreach ($question->answers as $answer_id => $answer){ 
                                ...
                                <div class='answer-block 
                                    <?php if(!empty( $answer->correct ) && $answer->correct == 'true'){ echo 'true-answer'; }else{ echo 'wrong-answer'; } ?>' data-item_id="<?php echo $answer_id; ?>
                                    <?php if(!empty( $answer->user_choice ) && $answer->user_choice !== 'false'){ echo ' user-choice';} ?>"
                                    > 
                                        ...
                                        <?php if(!empty($answer->answervalues)){ 
                                            foreach ($answer->answervalues as $answervalue_id => $answervalue){ 
                                                if(!empty($answervalue) && $answervalue->language == $exercise_form['language']){  ?> 
                                                    <span class="answer-text"><?php echo $answervalue->value; ?></span>
                                                    <span class="answer-points"><?php if(isset( $answer->answer_points)){ echo $answer->answer_points;} ?></span>
                                        <?php  } 
                                            } 
                                        }?>     
                                </div> 
    ...
    <div class="total-points">
        <div><?php echo $exercise_form['exercise']->points; ?></div>
        <div><?php echo $exercise_form['article_url']; ?></div>
    </div>
