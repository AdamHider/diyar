...
<div  class="autocomplete">
    <div id="special-symbols" style="display: none">
        <input class='input-letter button' type='button' onclick="enterSpecificLetter(this.value, 'autocomplete_input');" value='â'/>
        <input class='input-letter button' type='button' onclick="enterSpecificLetter(this.value, 'autocomplete_input');" value='ö'/>
        <input class='input-letter button' type='button' onclick="enterSpecificLetter(this.value, 'autocomplete_input');" value='ü'/>
        <input class='input-letter button' type='button' onclick="enterSpecificLetter(this.value, 'autocomplete_input');" value='ı'/>
        <input class='input-letter button' type='button' onclick="enterSpecificLetter(this.value, 'autocomplete_input');" value='ğ'/>
        <input class='input-letter button' type='button' onclick="enterSpecificLetter(this.value, 'autocomplete_input');" value='ş'/>
        <input class='input-letter button' type='button' onclick="enterSpecificLetter(this.value, 'autocomplete_input');" value='ç'/>
        <input class='input-letter button' type='button' onclick="enterSpecificLetter(this.value, 'autocomplete_input');" value='ñ'/>
    </div>
