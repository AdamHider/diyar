...
class __TwigTemplate_7ffc87d2bd3a38c96ab58de39037a81c3e431da232c12ed5878d6531cd554648 extends \Twig\Template
{
...
($context["gantry"] ?? null), "outlines", []), "title", [0 => $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "outline", [])], "method")) . "</strong>"))) . "<br />ID: ") . $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "atom", [])) . "<br />Replace: ") . twig_join_filter($this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "include", []), ", ")) . "\"")) : (""));
    ...
    {
        return new Source("<h2 class=\"page-title\">
...
</div>", "@gantry-admin/pages/configurations/page/atoms.html.twig", "W:\\iSell\\www\\diyar\\administrator\\components\\com_gantry5\\templates\\pages\\configurations\\page\\atoms.html.twig");
    }
}
