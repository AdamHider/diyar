...
class __TwigTemplate_920f0f314987d02493a59cc09d621ed69a39a004e6c8f8786c29b8032fa3968b extends \Twig\Template
{
...
";
    ...
    {
        return new Source("{% extends 'forms/fields/input/filepicker.html.twig' %}

{% block input %}
    {% set field = {'icon': 'fa-file-image-o', 'filter': '\\.(jpe?g|gif|png|svg|webp)\$'}|merge(field) %}
    {{ parent() }}
{% endblock %}
", "forms/fields/input/imagepicker.html.twig", "W:\\iSell\\www\\diyar\\administrator\\components\\com_gantry5\\templates\\forms\\fields\\input\\imagepicker.html.twig");
    }
}
