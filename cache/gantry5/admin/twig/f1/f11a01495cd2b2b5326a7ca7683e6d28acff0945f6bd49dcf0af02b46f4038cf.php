...
class __TwigTemplate_573daf092fdb23043e8827822977c3c9cd1b518cae614ed3901cd1b7b67ea7fb extends \Twig\Template
{
    ...
    {
        return new Source("<div class=\"g-inherit{{ inherit ? '' : ' hide' }}\">
    <div class=\"g-inherit-content\">
        {{ 'GANTRY5_PLATFORM_INHERITING_FROM_X'|trans('<strong>' ~ gantry.outlines.name(inherit)|e ~ '</strong>')|raw }}
    </div>
</div>", "forms/fields/gantry/inherit.html.twig", "W:\\iSell\\www\\diyar\\administrator\\components\\com_gantry5\\templates\\forms\\fields\\gantry\\inherit.html.twig");
    }
}
