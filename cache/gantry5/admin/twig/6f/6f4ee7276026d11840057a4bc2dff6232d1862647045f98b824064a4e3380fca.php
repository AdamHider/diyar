...
class __TwigTemplate_427a4f47207e95c2ae9b389df08b9a6189953fd0b2701b5f29f29d2350f47c89 extends \Twig\Template
{
...
";
    ...
    {
        return new Source("<div class=\"g-grid\">
    <div class=\"g-block navbar-block\">
        <nav id=\"gantry\">
                ...
                <ul>
                    ...
                    <li {{ (location == 'configurations/styles') ? 'class=\"active\"' }}>
                        <a data-g5-ajaxify=\"\"
                           ...
                           href=\"{{ gantry.route('configurations', configuration ?: 'default', 'styles') }}\"
                        >
                    ...
                    {% if (configuration and configuration != 'default') or not gantry.platform.no_base_layout %}
                        <li {{ (location == 'configurations/layout') ? 'class=\"active\"' }}>
                            <a data-g5-ajaxify=\"\"
                               ...
                               data-g5-ajaxify-target=\"[data-g5-content-wrapper]\"
                               data-g5-ajaxify-params=\"{{ {\"navbar\": true}|json_encode|e('html_attr') }}\"
                               href=\"{{ gantry.route('configurations', configuration ?: 'default', 'layout') }}\"
                            >
                    ...
                    <li {{ (location == 'configurations/page') ? 'class=\"active\"' }}>
                        <a data-g5-ajaxify=\"\"
                           ...
                           data-g5-ajaxify-target=\"[data-g5-content-wrapper]\"
                           data-g5-ajaxify-params=\"{{ {\"navbar\": true}|json_encode|e('html_attr') }}\"
                           href=\"{{ gantry.route('configurations', configuration ?: 'default', 'page') }}\"
                        >
                    ...
                    <li {{ (location == 'configurations/assignments') ? 'class=\"active\"' }}>
                        <a data-g5-ajaxify=\"\"
                           ...
                           data-g5-ajaxify-target=\"[data-g5-content-wrapper]\"
                           data-g5-ajaxify-params=\"{{ {\"navbar\": true}|json_encode|e('html_attr') }}\"
                           href=\"{{ gantry.route('configurations', configuration ?: 'default', 'assignments') }}\"
                        >
                    ...
                    {% if (location == 'configurations/settings' or gantry.particles.overrides(configuration)) %}
                        <li {{ (location == 'configurations/settings') ? 'class=\"active\"' }}>
                            <a data-g5-ajaxify=\"\"
                               ...
                               data-g5-ajaxify-target=\"[data-g5-content-wrapper]\"
                               data-g5-ajaxify-params=\"{{ {\"navbar\": true}|json_encode|e('html_attr') }}\"
                               href=\"{{ gantry.route('configurations', configuration ?: 'default', 'settings') }}\"
                            >
...
", "@gantry-admin/partials/navigation.html.twig", "W:\\iSell\\www\\diyar\\administrator\\components\\com_gantry5\\templates\\partials\\navigation.html.twig");
    }
}
