...
return [
    ...
    '_version' => 1,
    'id' => '5d7b500e5c5085.44264033',
    'content' => '<div id="contenttabs-2815-particle" class="g-content g-particle">            <div class="">
        
        <div class="g-contenttabs">
            <div id="g-contenttabs-contenttabs-2815" class="g-contenttabs-container">
                <ul class="g-contenttabs-tab-wrapper-container">

                                            <li class="g-contenttabs-tab-wrapper">
                            <span class="g-contenttabs-tab-wrapper-head">
                                <a class="g-contenttabs-tab" href="#g-contenttabs-item-contenttabs-2815-1">
                                    <span class="g-contenttabs-tab-title">Menu Editor</span>
                                            ...
                                            <li class="g-contenttabs-tab-wrapper">
                            <span class="g-contenttabs-tab-wrapper-head">
                                <a class="g-contenttabs-tab" href="#g-contenttabs-item-contenttabs-2815-2">
                ...
                <ul class="g-contenttabs-content-wrapper-container">
                            ...
                            <div class="g-contenttabs-tab-wrapper-body">
                                <div id="g-contenttabs-item-contenttabs-2815-1" class="g-contenttabs-content">
...
<div class="g-grid">
    <div class="g-block size-100">
        Find out more about using the Menu Editor in our <a href="http://docs.gantry.org/gantry5/configure/menu-editor">documentation</a>.
                                            ...
                                            <li class="g-contenttabs-tab-wrapper">
                            <div class="g-contenttabs-tab-wrapper-body">
                                <div id="g-contenttabs-item-contenttabs-2815-2" class="g-contenttabs-content">
...
<div>Find out more about using the Layout Manager in our <a href="http://docs.gantry.org/gantry5/configure/layout-manager">documentation</a>.</div>
    ...
    'scripts' => [
        ...
        'footer' => [
            'a10c7bef01461a0329c45d5927bcd8f07790fcd2b1422d0520ebf8afe9f509ae081a3345' => [
                ':type' => 'inline',
                ':priority' => 0,
                'content' => '
        jQuery(document).ready(function () {
            jQuery(\'#g-contenttabs-contenttabs-2815\').tabs({
                show: {
                                        effect: \'slide\',
                                        duration: 500
                }
