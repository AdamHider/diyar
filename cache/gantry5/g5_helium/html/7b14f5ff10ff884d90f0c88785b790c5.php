...
return [
    ...
    '_version' => 1,
    'id' => '5d7b53f49cb782.02187608',
    'content' => '<div id="contenttabs-7571-particle" class="g-content g-particle">            <div class="">
        
        <div class="g-contenttabs">
            <div id="g-contenttabs-contenttabs-7571" class="g-contenttabs-container">
                <ul class="g-contenttabs-tab-wrapper-container">

                                            <li class="g-contenttabs-tab-wrapper">
                            <span class="g-contenttabs-tab-wrapper-head">
                                <a class="g-contenttabs-tab" href="#g-contenttabs-item-contenttabs-7571-1">
                                    <span class="g-contenttabs-tab-title">Menu Editor</span>
                                            ...
                                            <li class="g-contenttabs-tab-wrapper">
                            <span class="g-contenttabs-tab-wrapper-head">
                                <a class="g-contenttabs-tab" href="#g-contenttabs-item-contenttabs-7571-2">
                ...
                <ul class="g-contenttabs-content-wrapper-container">
                            ...
                            <div class="g-contenttabs-tab-wrapper-body">
                                <div id="g-contenttabs-item-contenttabs-7571-1" class="g-contenttabs-content">
...
<div class="g-grid">
    <div class="g-block size-100">
        Find out more about using the Menu Editor in our <a href="http://docs.gantry.org/gantry5/configure/menu-editor">documentation</a>.
                                            ...
                                            <li class="g-contenttabs-tab-wrapper">
                            <div class="g-contenttabs-tab-wrapper-body">
                                <div id="g-contenttabs-item-contenttabs-7571-2" class="g-contenttabs-content">
...
<div>Find out more about using the Layout Manager in our <a href="http://docs.gantry.org/gantry5/configure/layout-manager">documentation</a>.</div>
    ...
    'scripts' => [
        'head' => [
            '1b1bdffa1060e565cd30a4abbbe53508a77d53442a0fc54c2b6d1a42133d1f0670f1d671' => [
                ':type' => 'file',
                ':priority' => 0,
                'src' => '/diyar/templates/g5_helium/js/juitabs.js',
        ...
        'footer' => [
            'a0d3a85cd2cd14b5e2044200dfc48a6a8845a7a32865b2789e0fc289ce86b4ab46efc175' => [
                ':type' => 'inline',
                ':priority' => 0,
                'content' => '
        jQuery(document).ready(function () {
            jQuery(\'#g-contenttabs-contenttabs-7571\').tabs({
                show: {
                                        effect: \'slide\',
                                        duration: 500
                }
