...
return [
    ...
    'timestamp' => 1568362508,
    'checksum' => '0bce5e00b561808764db0db41da05cda',
    'files' => [
    ...
    'data' => [
        'items' => [
            ...
            'particles.example_particle.enabled' => [
                'type' => 'input.checkbox',
                'label' => 'Enabled',
                'description' => 'Globally enable to the particles.',
                'default' => true,
                'name' => 'particles.example_particle.enabled'
            ],
            'particles.example_particle.title' => [
                'type' => 'input.text',
                'label' => 'Title',
                'description' => 'Customize the section title text.',
                'name' => 'particles.example_particle.title'
            ],
            'particles.example_particle.image' => [
                'type' => 'input.imagepicker',
                'label' => 'Image',
                'description' => 'Select the main image.',
                'name' => 'particles.example_particle.image'
            ],
            'particles.example_particle.description' => [
                'type' => 'textarea.textarea',
                'label' => 'Text / HTML',
                'description' => 'Create or modify your description.',
                'name' => 'particles.example_particle.description'
            ],
            'particles.example_particle.css' => [
                'type' => '_parent',
                'name' => 'particles.example_particle.css',
                'form_field' => false
            ],
            'particles.example_particle.css.class' => [
                'type' => 'input.text',
                'label' => 'Class',
                'description' => 'CSS class name for the particle.',
                'name' => 'particles.example_particle.css.class'
            ],
            'particles.horizontalmenu' => [
                'type' => '_root',
                'form_field' => false,
        ...
        'nested' => [
            'particles' => [
                ...
                'example_particle' => [
                    'enabled' => 'particles.example_particle.enabled',
                    'title' => 'particles.example_particle.title',
                    'image' => 'particles.example_particle.image',
                    'description' => 'particles.example_particle.description',
                    'css' => [
                        'class' => 'particles.example_particle.css.class'
                    ]
                ],
                'horizontalmenu' => [
